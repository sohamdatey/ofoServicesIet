<%@page import="co.ctl.ChangePasswordForRestaurantCtl"%>
...
<head>
<meta charset="utf-8">
<title>Change password For Restaurant</title>
<!--MOBILE DEVICE-->
<meta name="viewport"
...
<body>
	<form action="<%=ORSView.CHANGEPASSWORD_FOR_RESTAURANT_CTL%>"
		method="post">
		...
		<center>
			...
			<td colspan="2"><input type="submit" name="operation"
				class="btn btn-info"
				value="<%=ChangePasswordForRestaurantCtl.OP_SAVE%>"> &nbsp;<input
				type="submit" name="operation" class="btn btn-info"
				value="<%=ChangePasswordForRestaurantCtl.OP_RESET%>"> &nbsp;</td>
			</tr>
