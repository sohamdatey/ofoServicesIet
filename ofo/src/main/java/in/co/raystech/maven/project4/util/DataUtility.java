...
public class DataUtility {
	...
	public static List<FoodMenuDTO> remove(FoodMenuDTO bean, List<FoodMenuDTO> cart) {
		FoodMenuDTO beanMatch = new FoodMenuDTO();
		List<FoodMenuDTO> cart2 = new ArrayList<>();
		...
		{
			beanMatch = it.next();
			if (bean.getfId() != beanMatch.getfId()) {
				cart2.add(beanMatch);
			}
