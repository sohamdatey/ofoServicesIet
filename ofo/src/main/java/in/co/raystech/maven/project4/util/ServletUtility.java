...
import co.ctl.BaseCtl;
import co.ctl.ORSView;
...
public class ServletUtility {
	...
	public static void forwardSpecial(String page, HttpServletRequest request, HttpServletResponse response)
			throws IOException, ServletException {
		RequestDispatcher rd = request.getRequestDispatcher("/SpecialGetToPost");
	 ...
	 * 
	 * @deprecated Use HTMLUtility method instead
	 * @param request
	 * @return
	 */
	...
	public static void setMap(HashMap map, HttpServletRequest request) {
		request.setAttribute("map", map);
	}
	
	public static HashMap getMap(HttpServletRequest request) {
		return (HashMap) request.getAttribute("map");
	}
	...
	public static void setDishName(String dishName, HttpServletRequest request) {
		request.setAttribute("dishName", dishName);
	}

	
	
	public static String getDishName(HttpServletRequest request) {
		return (String) request.getAttribute("dishName");
	}
	public static void setResName(String ResName, HttpServletRequest request) {
		request.setAttribute("ResName", ResName);
	}

	
	
	public static String getResName(HttpServletRequest request) {
		return (String) request.getAttribute("ResName");
	}
