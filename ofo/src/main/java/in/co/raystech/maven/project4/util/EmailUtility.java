...
public class EmailUtility {
	 ...
	 * class path or, by placing j2ee.jar in the class path The javax.mail API
	 * uses a properties file for reading server names and related
	 * configuration. These settings will override any system defaults.
	 * Alternatively, the configuration can be set directly in code, using the
	 * JavaMail API.
	 * 
	 */
