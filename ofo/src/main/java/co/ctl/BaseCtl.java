...
public abstract class BaseCtl extends HttpServlet {
	...
	public static final String OP_ADD_TO_CART = "Add To Cart";

	public static final String OP_DELETE_FROM_CART = "Delete from Cart";
	public static final String OP_CHECK_CART ="Check cart";
	public static final String OP_ADD_MORE_DISHES_TO_YOUR_CART = "Add More Dishes to your cart";

	public static final String OP_ADD_THIS_DISH_TO_YOUR_MENU = "Add This Dish to your Menu";

	public static final String OP_REFRESH = "Refresh";

	public static final String OP_ADD_COMPLETELY_NEW_DISH = "Add Completely NewDish";
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		// Load the pre-loaded data required to display at HTML form
		preload(request);
