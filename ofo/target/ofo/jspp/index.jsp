...
<body
	...
	<div id="search_bar_wrapper" class="search_bar search-zindex" role="form">
										...
										<div class="flex-shrink-1 search-box plr0i ml5 mr5" style="border-bottom-left-radius: 3px; border-bottom-right-radius: 3px;">
											<div id="keywords_container" class="col-s-16 pr0">
												<div id="keywords_pretext">
													...
													<div class="k-pre-2  w100">
														<span class="search-bar-icon mr5">🔍</span> <label id="label_search_res" class="hdn">Search for
															restaurants or cuisines...</label> <input type="text" value="m" name="searchRestaurant" role="combobox" aria-expanded="true" aria-autocomplete="list" aria-owns="keywords-by" aria-labelledby="label_search_res" id="keywords_input" class="discover-search" placeholder="Search for restaurants or cuisines..." autocomplete="off">
													</div>
												</div>
										...
										<div class="flex-shrink-0 plr0i">
											&ensp;&ensp; <input type="submit" name="operation" class="btn btn-info" value="Search">
				...
				<div class="search_category_wrapper col-l-11 hidden">
					<div
						...
						<a id="scroll_left_arrow"
							...
							class="item search_category">CafÃ©s</a><a
								...
								<div class="search-filter-tab pt0 pb0 mtop"
									...
									<div id="filter-cost-html-area" class="facet-list-dialog">
										<a href="/indore/restaurants/mcdonalds?cft=0"><div
												...
												Less than â‚¹350 <span class="right grey-text">0</span>
											</div></a><a href="/indore/restaurants/mcdonalds?cft=1"><div
												class="link_hover w100 search_filter cft cursor-pointer">
												â‚¹350 to â‚¹750<span class="right grey-text">4</span>
											</div></a><a href="/indore/restaurants/mcdonalds?cft=2"><div
												class="link_hover w100 search_filter cft cursor-pointer">
												â‚¹750 to â‚¹1,500<span class="right grey-text">0</span>
											</div></a><a href="/indore/restaurants/mcdonalds?cft=3"><div
												class="link_hover w100 search_filter cft cursor-pointer">
												â‚¹1,500 +<span class="right grey-text">0</span>
											</div></a>
									</div>
								</div>
																	...
																	<div class="search-page-text clearfix row">
																		...
																		<div class="res-cost clearfix">
																			<span
																				...
																				for two:</span><span class="col-s-11 col-m-12 pl0">â‚¹400</span>
																		</div>
